package com.high.extension.spring;

import com.high.config.GlobalConfig;
import com.high.core.MybatisConfiguration;
import com.high.core.MybatisSqlSessionFactoryBuilder;
import com.high.core.MybatisXMLConfigBuilder;
import com.high.core.enums.DbType;
import com.high.core.enums.IEnum;
import com.high.core.toolkit.StringPool;
import com.high.extension.handlers.EnumTypeHandler;
import com.high.extension.toolkit.PackageHelper;
import com.high.extension.toolkit.SqlHelper;
import com.high.util.*;
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        if (globalConfig.getDbConfig().getDbType() == DbType.OTHER) {
            try (Connection connection = AopUtils.getTargetObject(this.dataSource).getConnection()) {
                ...
                throw ExceptionUtils.build("Error: GlobalConfigUtils setMetaData Fail !  Cause:" + e);
            }
        }
