...
import com.high.core.toolkit.support.BiIntFunction;
...
public class StringUtils {
    ...
    public static String blob2String(Blob blob) {
        if (null != blob) {
            try {
                ...
                throw ExceptionUtils.build("Blob Convert To String Error!");
            }
        }
        return null;
    }
     ...
     * @return
     */
    public static String removePrefixBlankWord(String content,String word){
        String regex = "\\s+" + word;
