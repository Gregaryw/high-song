package com.high.core.toolkit;

import com.high.annotation.KeySequence;
import com.high.annotation.TableField;
import com.high.annotation.TableId;
import com.high.annotation.TableName;
...
public class TableInfoHelper {
    ...
    private static boolean initTableFieldWithAnnotation(GlobalConfig.DbConfig dbConfig, TableInfo tableInfo,
        ...
        throw ExceptionUtils.build("Class: %s, Field: %s, 'value' 'el' Length must be consistent.",
    ...
    private static void throwExceptionId(Class<?> clazz) {
        throw ExceptionUtils.build("There must be only one, Discover multiple @TableId annotation in %s", clazz.getName());
    }
