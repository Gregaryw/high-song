...
public class ReflectionKit {
    ...
    public static Object getMethodValue(Class<?> cls, Object entity, String str) {
        ...
        try {
            ...
            throw ExceptionUtils.build("Error: NoSuchMethod in %s.  Cause:", e, cls.getSimpleName());
        } catch (IllegalAccessException e) {
            throw ExceptionUtils.build("Error: Cannot execute a private method. in %s.  Cause:", e, cls.getSimpleName());
        } catch (InvocationTargetException e) {
            throw ExceptionUtils.build("Error: InvocationTargetException on getMethodValue.  Cause:" + e);
        }
    }
    ...
    public static Method getMethod(Class<?> cls, Field field) {
        try {
            ...
            throw ExceptionUtils.build("Error: NoSuchMethod in %s.  Cause:", e, cls.getName());
        }
    }
}
